    ...
    <div className={styles.authPage}>
      <div className={styles.authCard}>
        <div className={styles.authCard__header}>
          ...
          <h1 className={styles.authCard__title}>Welcome back</h1>
        ...
        <Card>
          <CardBody>
            <div className={styles.authCard__form}>
              ...
              <form onSubmit={handleLogin} className={styles.authCard__form}>
  ...
  return (
    <Suspense fallback={
      <div className={styles.authPage}>
        <div className={styles.authCard}>
          <div className={styles.authCard__header}>
            <div className="skeleton" style={{ width: 120, height: 40, margin: '0 auto var(--space-4)' }} />
            <div className="skeleton" style={{ width: 200, height: 24, margin: '0 auto var(--space-2)' }} />
